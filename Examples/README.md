...
how to write the README, Makefile and manifest files. If you take this example
as a template, we recommend to remove the comments from your copies as they only
add noise.
