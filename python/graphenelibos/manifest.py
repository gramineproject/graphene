...
Template functions and macros
-----------------------------

.. function:: get_runtimedir([libc])

    Return the path to runtime directory for a particular libc, either
    :file:`/usr/lib/graphene/runtime/<libc>/lib` or :file:`Runtime/` in repo, depending on whether
