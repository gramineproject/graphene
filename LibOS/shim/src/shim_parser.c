...
struct parser_table {
    ...
    [__NR_read]     = {.slow = true, .name = "read", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_write]    = {.slow = true, .name = "write", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_open]     = {.slow = true, .name = "open", .parser = {&parse_long_arg, &parse_string_arg, &parse_open_flags, &parse_open_mode}},
    [__NR_close]    = {.slow = false, .name = "close", .parser = {&parse_long_arg, &parse_integer_arg}},
    [__NR_stat]     = {.slow = false, .name = "stat", .parser = {&parse_long_arg, &parse_string_arg, &parse_pointer_arg}},
    [__NR_fstat]    = {.slow = false, .name = "fstat", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg}},
    [__NR_lstat]    = {.slow = false, .name = "lstat", .parser = {&parse_long_arg, &parse_string_arg, &parse_pointer_arg}},
    [__NR_poll]     = {.slow = true, .name = "poll", .parser = {&parse_long_arg, &parse_pointer_arg, &parse_integer_arg, &parse_integer_arg}},
    [__NR_lseek]    = {.slow = false, .name = "lseek", .parser = {&parse_long_arg, &parse_integer_arg, &parse_long_arg, &parse_seek}},
    [__NR_mmap]     = {.slow = true, .name = "mmap", .parser = {&parse_pointer_ret, &parse_pointer_arg, &parse_pointer_arg, &parse_mmap_prot, &parse_mmap_flags, &parse_integer_arg, &parse_long_arg}},
    [__NR_mprotect] = {.slow = true, .name = "mprotect", .parser = {&parse_long_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_mmap_prot}},
    [__NR_munmap]   = {.slow = true, .name = "munmap", .parser = {&parse_long_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_brk]      = {.slow = false, .name = "brk", .parser = {&parse_pointer_ret, &parse_pointer_arg}},
    [__NR_rt_sigaction]   = {.slow = false, .name = "rt_sigaction", .parser = {&parse_long_arg, &parse_signum, &parse_pointer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_rt_sigprocmask] = {.slow = false, .name = "rt_sigprocmask", .parser = {&parse_long_arg, &parse_sigprocmask_how, &parse_sigmask, &parse_sigmask}},
    [__NR_rt_sigreturn]   = {.slow = false, .name = "rt_sigreturn", .parser = {NULL}},
    [__NR_ioctl]          = {.slow = true, .name = "ioctl", .parser = {&parse_long_arg, &parse_integer_arg, &parse_ioctlop, &parse_pointer_arg}},
    [__NR_pread64]        = {.slow = true, .name = "pread64", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_long_arg}},
    [__NR_pwrite64]       = {.slow = false, .name = "pwrite64", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_long_arg}},
    [__NR_readv]          = {.slow = true, .name = "readv", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_integer_arg}},
    [__NR_writev]         = {.slow = false, .name = "writev", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_integer_arg}},
    [__NR_access]         = {.slow = false, .name = "access", .parser = {&parse_long_arg, &parse_string_arg, &parse_access_mode}},
    [__NR_pipe]           = {.slow = false, .name = "pipe", .parser = {&parse_long_arg, &parse_pipe_fds}},
    [__NR_select]         = {.slow = true, .name = "select", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    ...
    [__NR_mincore]     = {.slow = false, .name = "mincore", .parser = {&parse_long_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_madvise]     = {.slow = false, .name = "madvise", .parser = {&parse_long_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_madvise_behavior}},
    ...
    [__NR_dup2]        = {.slow = false, .name = "dup2", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg}},
    [__NR_pause]       = {.slow = true, .name = "pause", .parser = {&parse_long_arg}},
    [__NR_nanosleep]   = {.slow = true, .name = "nanosleep", .parser = {&parse_long_arg, &parse_timespec, &parse_pointer_arg}},
    [__NR_getitimer]   = {.slow = false, .name = "getitimer", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg}},
    [__NR_alarm]       = {.slow = false, .name = "alarm", .parser = {&parse_long_arg, &parse_integer_arg}},
    [__NR_setitimer]   = {.slow = false, .name = "setitimer", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_getpid]      = {.slow = false, .name = "getpid", .parser = {&parse_long_arg}},
    [__NR_sendfile]    = {.slow = false, .name = "sendfile", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_socket]      = {.slow = false, .name = "socket", .parser = {&parse_long_arg, &parse_domain, &parse_socktype, &parse_integer_arg}},
    [__NR_connect]     = {.slow = true, .name = "connect", .parser = {&parse_long_arg, &parse_integer_arg, &parse_sockaddr, &parse_integer_arg}},
    [__NR_accept]      = {.slow = true, .name = "accept", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_sendto]      = {.slow = false, .name = "sendto", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_integer_arg, &parse_pointer_arg, &parse_integer_arg}},
    [__NR_recvfrom]    = {.slow = false, .name = "recvfrom", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_sendmsg]     = {.slow = false, .name = "sendmsg", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_integer_arg}},
    [__NR_recvmsg]     = {.slow = true, .name = "recvmsg", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_integer_arg}},
    [__NR_shutdown]    = {.slow = false, .name = "shutdown", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg}},
    [__NR_bind]        = {.slow = false, .name = "bind", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_integer_arg}},
    [__NR_listen]      = {.slow = false, .name = "listen", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg}},
    [__NR_getsockname] = {.slow = false, .name = "getsockname", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_getpeername] = {.slow = false, .name = "getpeername", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_socketpair]  = {.slow = false, .name = "socketpair", .parser = {&parse_long_arg, &parse_domain, &parse_socktype, &parse_integer_arg, &parse_pipe_fds}},
    [__NR_setsockopt]  = {.slow = false, .name = "setsockopt", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg, &parse_integer_arg, &parse_pointer_arg, &parse_integer_arg}},
    [__NR_getsockopt]  = {.slow = false, .name = "getsockopt", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_clone]    = {.slow = true, .name = "clone", .parser = {&parse_long_arg, &parse_clone_flags, &parse_pointer_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_fork]     = {.slow = true, .name = "fork", .parser = {&parse_long_arg}},
    [__NR_vfork]    = {.slow = true, .name = "vfork", .parser = {&parse_long_arg}},
    [__NR_execve]   = {.slow   = true, .name = "execve", .parser = {&parse_long_arg, &parse_string_arg, &parse_exec_args, &parse_exec_envp}},
    [__NR_exit]     = {.slow = false, .name = "exit", .parser = {&parse_long_arg, &parse_integer_arg}},
    [__NR_wait4]    = {.slow = true, .name = "wait4", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_wait_options, &parse_pointer_arg}},
    [__NR_kill]     = {.slow = false, .name = "kill", .parser = {&parse_long_arg, &parse_integer_arg, &parse_signum}},
    [__NR_uname]    = {.slow = false, .name = "uname", .parser = {&parse_long_arg, &parse_pointer_arg}},
    [__NR_semget]   = {.slow = false, .name = "semget", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg, &parse_integer_arg}},
    [__NR_semop]    = {.slow = true, .name = "semop", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_integer_arg}},
    [__NR_semctl]   = {.slow = false, .name = "semctl", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg, &parse_integer_arg, &parse_pointer_arg}},
    [__NR_shmdt]    = {.slow = false, .name = "shmdt", .parser = {NULL}},
    [__NR_msgget]   = {.slow = true, .name = "msgget", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg}},
    [__NR_msgsnd]   = {.slow = true, .name = "msgsnd", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_integer_arg}},
    [__NR_msgrcv]   = {.slow = true, .name = "msgrcv", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_long_arg, &parse_integer_arg}},
    [__NR_msgctl]   = {.slow = true, .name = "msgctl", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg, &parse_pointer_arg}},
    [__NR_fcntl]    = {.slow = false, .name = "fcntl", .parser = {&parse_long_arg, &parse_integer_arg, &parse_fcntlop, &parse_pointer_arg}},
    [__NR_flock]    = {.slow = false, .name = "flock", .parser = {NULL}},
    [__NR_fsync]    = {.slow = false, .name = "fsync", .parser = {&parse_long_arg, &parse_integer_arg}},
    [__NR_fdatasync] = {.slow = false, .name = "fdatasync", .parser = {&parse_long_arg, &parse_integer_arg}},
    [__NR_truncate]  = {.slow = false, .name = "truncate", .parser = {&parse_long_arg, &parse_string_arg, &parse_long_arg}},
    [__NR_ftruncate] = {.slow = false, .name = "ftruncate", .parser = {&parse_long_arg, &parse_integer_arg, &parse_long_arg}},
    [__NR_getdents]  = {.slow = false, .name = "getdents", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_getcwd]   = {.slow = false, .name = "getcwd", .parser = {&parse_long_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_chdir]    = {.slow = false, .name = "chdir", .parser = {&parse_long_arg, &parse_string_arg}},
    [__NR_fchdir]   = {.slow = false, .name = "fchdir", .parser = {&parse_long_arg, &parse_integer_arg}},
    [__NR_rename]   = {.slow = false, .name = "rename", .parser = {&parse_long_arg, &parse_string_arg, &parse_string_arg}},
    [__NR_mkdir]    = {.slow = false, .name = "mkdir", .parser = {&parse_long_arg, &parse_string_arg, &parse_integer_arg}},
    [__NR_rmdir]    = {.slow = false, .name = "rmdir", .parser = {&parse_long_arg, &parse_string_arg}},
    [__NR_creat]    = {.slow = false, .name = "creat", .parser = {&parse_long_arg, &parse_string_arg, &parse_open_mode}},
    ...
    [__NR_readlink] = {.slow = false, .name = "readlink", .parser = {&parse_long_arg, &parse_string_arg, &parse_pointer_arg, &parse_integer_arg}},
    [__NR_chmod]    = {.slow = false, .name = "chmod", .parser = {&parse_long_arg, &parse_string_arg, &parse_integer_arg}},
    [__NR_fchmod]   = {.slow = false, .name = "fchmod", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg}},
    [__NR_chown]    = {.slow = false, .name = "chown", .parser = {&parse_long_arg, &parse_string_arg, &parse_integer_arg, &parse_integer_arg}},
    [__NR_fchown]   = {.slow = false, .name = "fchown", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg, &parse_integer_arg}},
    [__NR_lchown]   = {.slow = false, .name = "lchown", .parser = {NULL}},
    [__NR_umask]    = {.slow = false, .name = "umask", .parser = {&parse_long_arg, &parse_integer_arg}},
    [__NR_gettimeofday] = {.slow = false, .name = "gettimeofday", .parser = {&parse_long_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_getrlimit]    = {.slow = false, .name = "getrlimit", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg}},
    ...
    [__NR_setuid]    = {.slow = false, .name = "setuid", .parser = {&parse_long_arg, &parse_integer_arg}},
    [__NR_setgid]    = {.slow = false, .name = "setgid", .parser = {&parse_long_arg, &parse_integer_arg}},
    [__NR_geteuid]   = {.slow = false, .name = "geteuid", .parser = {&parse_long_arg}},
    [__NR_getegid]   = {.slow = false, .name = "getegid", .parser = {&parse_long_arg}},
    [__NR_setpgid]   = {.slow = false, .name = "setpgid", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg}},
    ...
    [__NR_getgroups] = {.slow = false, .name = "getgroups", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg}},
    [__NR_setgroups] = {.slow = false, .name = "setgroups", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg}},
    ...
    [__NR_getpgid]   = {.slow = false, .name = "getpgid", .parser = {&parse_long_arg, &parse_integer_arg}},
    [__NR_setfsuid]  = {.slow = false, .name = "setfsuid", .parser = {NULL}},
    [__NR_setfsgid]  = {.slow = false, .name = "setfsgid", .parser = {NULL}},
    [__NR_getsid]    = {.slow = false, .name = "getsid", .parser = {&parse_long_arg, &parse_integer_arg}},
    [__NR_capget]    = {.slow = false, .name = "capget", .parser = {NULL}},
    [__NR_capset]    = {.slow = false, .name = "capset", .parser = {NULL}},
    [__NR_rt_sigpending]   = {.slow = false, .name = "rt_sigpending", .parser = {&parse_long_arg, &parse_pointer_arg, &parse_pointer_arg}},
    ...
    [__NR_rt_sigsuspend]   = {.slow = true, .name = "rt_sigsuspend", .parser = {&parse_long_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_sigaltstack]     = {.slow = false, .name = "sigaltstack", .parser = {&parse_long_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_utime]       = {.slow = false, .name = "utime", .parser = {NULL}},
    [__NR_mknod]       = {.slow = false, .name = "mknod", .parser = {&parse_long_arg, &parse_string_arg, &parse_open_mode, &parse_integer_arg}},
    ...
    [__NR_statfs]      = {.slow = false, .name = "statfs", .parser = {&parse_long_arg, &parse_string_arg, &parse_pointer_arg}},
    [__NR_fstatfs]     = {.slow = false, .name = "fstatfs", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg}},
    [__NR_sysfs]       = {.slow = false, .name = "sysfs", .parser = {NULL}},
    [__NR_getpriority]    = {.slow = false, .name = "getpriority", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg}},
    [__NR_setpriority]    = {.slow = false, .name = "setpriority", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg, &parse_integer_arg}},
    [__NR_sched_setparam] = {.slow = false, .name = "sched_setparam", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg}},
    [__NR_sched_getparam] = {.slow = false, .name = "sched_getparam", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg}},
    [__NR_sched_setscheduler]     = {.slow = false, .name = "sched_setscheduler", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg, &parse_pointer_arg}},
    [__NR_sched_getscheduler]     = {.slow = false, .name = "sched_getscheduler", .parser = {&parse_long_arg, &parse_integer_arg}},
    [__NR_sched_get_priority_max] = {.slow = false, .name = "sched_get_priority_max", .parser = {&parse_long_arg, &parse_integer_arg}},
    [__NR_sched_get_priority_min] = {.slow = false, .name = "sched_get_priority_min", .parser = {&parse_long_arg, &parse_integer_arg}},
    [__NR_sched_rr_get_interval]  = {.slow = false, .name = "sched_rr_get_interval", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg}},
    ...
    [__NR_arch_prctl] = {.slow = false, .name = "arch_prctl", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg}},
#endif
    [__NR_adjtimex]  = {.slow = false, .name = "adjtimex", .parser = {NULL}},
    [__NR_setrlimit] = {.slow = false, .name = "setrlimit", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg}},
    ...
    [__NR_sethostname]   = {.slow = false, .name = "sethostname", .parser = {&parse_long_arg, &parse_pointer_arg, &parse_integer_arg}},
    [__NR_setdomainname] = {.slow = false, .name = "setdomainname", .parser = {&parse_long_arg, &parse_pointer_arg, &parse_integer_arg}},
#ifdef __NR_iopl
    ...
    [__NR_tkill]        = {.slow = false, .name = "tkill", .parser = {&parse_long_arg, &parse_integer_arg, &parse_signum}},
    [__NR_time]         = {.slow = false, .name = "time", .parser = {&parse_long_arg, &parse_pointer_arg}},
    [__NR_futex]        = {.slow = true, .name = "futex", .parser = {&parse_long_arg, &parse_pointer_arg, &parse_futexop, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_integer_arg}},
    [__NR_sched_setaffinity] = {.slow = false, .name = "sched_setaffinity", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg, &parse_pointer_arg}},
    [__NR_sched_getaffinity] = {.slow = false, .name = "sched_getaffinity", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg, &parse_pointer_arg}},
    ...
    [__NR_epoll_create]     = {.slow = false, .name = "epoll_create", .parser = {&parse_long_arg, &parse_integer_arg}},
    ...
    [__NR_getdents64]       = {.slow = false, .name = "getdents64", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_set_tid_address]  = {.slow = false, .name = "set_tid_address", .parser = {&parse_long_arg, &parse_pointer_arg}},
    [__NR_restart_syscall]  = {.slow = false, .name = "restart_syscall", .parser = {NULL}},
    [__NR_semtimedop]       = {.slow = false, .name = "semtimedop", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_integer_arg, &parse_pointer_arg}},
    ...
    [__NR_clock_gettime]    = {.slow = false, .name = "clock_gettime", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg}},
    [__NR_clock_getres]     = {.slow = false, .name = "clock_getres", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg}},
    [__NR_clock_nanosleep]  = {.slow = false, .name = "clock_nanosleep", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_exit_group]       = {.slow = false, .name = "exit_group", .parser = {&parse_long_arg, &parse_integer_arg}},
    [__NR_epoll_wait]       = {.slow = true, .name = "epoll_wait", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_integer_arg, &parse_integer_arg}},
    [__NR_epoll_ctl]        = {.slow = false, .name = "epoll_ctl", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg, &parse_integer_arg, &parse_pointer_arg}},
    [__NR_tgkill]           = {.slow = false, .name = "tgkill", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg, &parse_signum}},
    [__NR_utimes]           = {.slow = false, .name = "utimes", .parser = {NULL}},
#ifdef __NR_vserver
    [__NR_vserver]          = {.slow = false, .name = "vserver", .parser = {NULL}},
#endif
    [__NR_mbind]           = {.slow = false, .name = "mbind", .parser = {&parse_long_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_integer_arg}},
    ...
    [__NR_waitid]      = {.slow   = true, .name = "waitid", .parser = {&parse_long_arg, &parse_waitid_which, &parse_integer_arg, &parse_pointer_arg, &parse_wait_options, &parse_pointer_arg}},
    ...
    [__NR_openat]     = {.slow   = false, .name = "openat", .parser = {&parse_long_arg, &parse_at_fdcwd, &parse_string_arg, &parse_open_flags, &parse_open_mode}},
    [__NR_mkdirat]    = {.slow = false, .name = "mkdirat", .parser = {&parse_long_arg, &parse_at_fdcwd, &parse_string_arg, &parse_integer_arg}},
    [__NR_mknodat]    = {.slow = false, .name = "mknodat", .parser = {&parse_long_arg, &parse_at_fdcwd, &parse_string_arg, &parse_open_mode, &parse_integer_arg}},
    [__NR_fchownat]   = {.slow = false, .name = "fchownat", .parser = {&parse_long_arg, &parse_at_fdcwd, &parse_string_arg, &parse_integer_arg, &parse_integer_arg, &parse_integer_arg}},
    [__NR_futimesat]  = {.slow = false, .name = "futimesat", .parser = {NULL}},
    [__NR_newfstatat] = {.slow = false, .name = "newfstatat", .parser = {&parse_long_arg, &parse_at_fdcwd, &parse_string_arg, &parse_pointer_arg, &parse_integer_arg}},
    [__NR_unlinkat]   = {.slow = false, .name = "unlinkat", .parser = {&parse_long_arg, &parse_at_fdcwd, &parse_string_arg, &parse_integer_arg}},
    [__NR_renameat]   = {.slow = false, .name = "renameat", .parser = {&parse_long_arg, &parse_at_fdcwd, &parse_string_arg, &parse_integer_arg, &parse_string_arg}},
    [__NR_linkat]     = {.slow = false, .name = "linkat", .parser = {NULL}},
    [__NR_symlinkat]  = {.slow = false, .name = "symlinkat", .parser = {NULL}},
    [__NR_readlinkat] = {.slow = false, .name = "readlinkat", .parser = {&parse_long_arg, &parse_at_fdcwd, &parse_string_arg, &parse_pointer_arg, &parse_integer_arg}},
    [__NR_fchmodat]   = {.slow = false, .name = "fchmodat", .parser = {&parse_long_arg, &parse_at_fdcwd, &parse_string_arg, &parse_integer_arg}},
    [__NR_faccessat]  = {.slow = false, .name = "faccessat", .parser = {&parse_long_arg, &parse_at_fdcwd, &parse_string_arg, &parse_integer_arg}},
    [__NR_pselect6]   = {.slow = true, .name = "pselect6", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_ppoll]      = {.slow = true, .name = "ppoll", .parser = {&parse_long_arg, &parse_pointer_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_unshare]    = {.slow = false, .name = "unshare", .parser = {NULL}},
    [__NR_set_robust_list] = {.slow = false, .name = "set_robust_list", .parser = {&parse_long_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_get_robust_list] = {.slow = false, .name = "get_robust_list", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    ...
    [__NR_epoll_pwait]     = {.slow = true, .name = "epoll_pwait", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_integer_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    [__NR_signalfd]        = {.slow = false, .name = "signalfd", .parser = {NULL}},
    [__NR_timerfd_create]  = {.slow = false, .name = "timerfd_create", .parser = {NULL}},
    [__NR_eventfd]         = {.slow = false, .name = "eventfd", .parser = {&parse_long_arg, &parse_integer_arg}},
    ...
    [__NR_accept4]       = {.slow = true, .name = "accept4", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_integer_arg}},
    [__NR_signalfd4]     = {.slow = false, .name = "signalfd4", .parser = {NULL}},
    [__NR_eventfd2]      = {.slow = false, .name = "eventfd2", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg}},
    [__NR_epoll_create1] = {.slow = false, .name = "epoll_create1", .parser = {&parse_long_arg, &parse_integer_arg}},
    [__NR_dup3]          = {.slow = false, .name = "dup3", .parser = {&parse_long_arg, &parse_integer_arg, &parse_integer_arg, &parse_integer_arg}},
    [__NR_pipe2]         = {.slow = false, .name = "pipe2", .parser = {&parse_long_arg, &parse_pointer_arg, &parse_integer_arg}},
    ...
    [__NR_recvmmsg]          = {.slow = false, .name = "recvmmsg", .parser = {&parse_long_arg, &parse_integer_arg, &parse_pointer_arg, &parse_integer_arg, &parse_integer_arg, &parse_pointer_arg}},
    [__NR_getcpu]        = {.slow = false, .name = "getcpu", .parser = {&parse_long_arg, &parse_pointer_arg, &parse_pointer_arg, &parse_pointer_arg}},
    ...
    [__NR_getrandom]         = {.slow = false, .name = "getrandom", .parser = {&parse_long_arg, &parse_pointer_arg, &parse_pointer_arg, parse_getrandom_flags}},
