...
SHIM_SYSCALL_RETURN_ENOSYS_5(mremap, void*, void*, addr, size_t, old_len, size_t, new_len, int,
                             flags, void*, new_addr)

SHIM_SYSCALL_RETURN_ENOSYS_3(msync, int, void*, start, size_t, len, int, flags)

/* mincore: sys/shim_mmap.c */
DEFINE_SHIM_SYSCALL(mincore, 3, shim_do_mincore, int, void*, start, size_t, len, unsigned char*,
                    vec)

SHIM_SYSCALL_RETURN_ENOSYS_3(madvise, int, void*, start, size_t, len, int, behavior)

SHIM_SYSCALL_RETURN_ENOSYS_3(shmget, int, key_t, key, size_t, size, int, shmflg)

SHIM_SYSCALL_RETURN_ENOSYS_3(shmat, void*, int, shmid, const void*, shmaddr, int, shmflg)

SHIM_SYSCALL_RETURN_ENOSYS_3(shmctl, int, int, shmid, int, cmd, struct shmid_ds*, buf)
...
SHIM_SYSCALL_RETURN_ENOSYS_1(shmdt, int, const void*, shmaddr)
...
SHIM_SYSCALL_RETURN_ENOSYS_2(flock, int, int, fd, int, cmd)
...
SHIM_SYSCALL_RETURN_ENOSYS_2(link, int, const char*, oldname, const char*, newname)

/* unlink: sys/shim_fs.c */
DEFINE_SHIM_SYSCALL(unlink, 1, shim_do_unlink, int, const char*, file)

SHIM_SYSCALL_RETURN_ENOSYS_2(symlink, int, const char*, old, const char*, new)
...
SHIM_SYSCALL_RETURN_ENOSYS_3(lchown, int, const char*, filename, uid_t, user, gid_t, group)
...
SHIM_SYSCALL_RETURN_ENOSYS_1(sysinfo, int, struct sysinfo*, info)

SHIM_SYSCALL_RETURN_ENOSYS_1(times, int, struct tms*, tbuf)

SHIM_SYSCALL_RETURN_ENOSYS_4(ptrace, int, long, request, pid_t, pid, void*, addr, void*, data)

/* getuid: sys/shim_getpid.c */
DEFINE_SHIM_SYSCALL(getuid, 0, shim_do_getuid, uid_t)

SHIM_SYSCALL_RETURN_ENOSYS_3(syslog, int, int, type, char*, buf, int, len)
...
SHIM_SYSCALL_RETURN_ENOSYS_2(setreuid, int, uid_t, ruid, uid_t, euid)

SHIM_SYSCALL_RETURN_ENOSYS_2(setregid, int, gid_t, rgid, gid_t, egid)

SHIM_SYSCALL_RETURN_ENOSYS_3(setresuid, int, uid_t, ruid, uid_t, euid, uid_t, suid)

SHIM_SYSCALL_RETURN_ENOSYS_3(getresuid, int, uid_t*, ruid, uid_t*, euid, uid_t*, suid)

SHIM_SYSCALL_RETURN_ENOSYS_3(setresgid, int, gid_t, rgid, gid_t, egid, gid_t, sgid)

SHIM_SYSCALL_RETURN_ENOSYS_3(getresgid, int, gid_t*, rgid, gid_t*, egid, gid_t*, sgid)

DEFINE_SHIM_SYSCALL(getpgid, 1, shim_do_getpgid, int, pid_t, pid)

SHIM_SYSCALL_RETURN_ENOSYS_1(setfsuid, int, uid_t, uid)

SHIM_SYSCALL_RETURN_ENOSYS_1(setfsgid, int, gid_t, gid)

DEFINE_SHIM_SYSCALL(getsid, 1, shim_do_getsid, int, pid_t, pid)

SHIM_SYSCALL_RETURN_ENOSYS_2(capget, int, cap_user_header_t, header, cap_user_data_t, dataptr)

SHIM_SYSCALL_RETURN_ENOSYS_2(capset, int, cap_user_header_t, header, const cap_user_data_t, data)

DEFINE_SHIM_SYSCALL(rt_sigpending, 2, shim_do_sigpending, int, __sigset_t*, set, size_t, sigsetsize)

SHIM_SYSCALL_RETURN_ENOSYS_4(rt_sigtimedwait, int, const __sigset_t*, uthese, siginfo_t*, uinfo,
                             const struct timespec*, uts, size_t, sigsetsize)

SHIM_SYSCALL_RETURN_ENOSYS_3(rt_sigqueueinfo, int, int, pid, int, sig, siginfo_t*, uinfo)
...
SHIM_SYSCALL_RETURN_ENOSYS_2(utime, int, char*, filename, struct utimbuf*, times)

DEFINE_SHIM_SYSCALL(mknod, 3, shim_do_mknod, int, const char*, filename, int, mode, unsigned, dev)

SHIM_SYSCALL_RETURN_ENOSYS_1(uselib, int, const char*, library)

SHIM_SYSCALL_RETURN_ENOSYS_1(personality, int, unsigned int, personality)

SHIM_SYSCALL_RETURN_ENOSYS_2(ustat, int, unsigned, dev, struct __kernel_ustat*, ubuf)

SHIM_SYSCALL_RETURN_ENOSYS_2(statfs, int, const char*, path, struct statfs*, buf)

SHIM_SYSCALL_RETURN_ENOSYS_2(fstatfs, int, int, fd, struct statfs*, buf)

SHIM_SYSCALL_RETURN_ENOSYS_3(sysfs, int, int, option, unsigned long, arg1, unsigned long, arg2)
...
SHIM_SYSCALL_RETURN_ENOSYS_2(mlock, int, void*, start, size_t, len)

SHIM_SYSCALL_RETURN_ENOSYS_2(munlock, int, void*, start, size_t, len)

SHIM_SYSCALL_RETURN_ENOSYS_1(mlockall, int, int, flags)

SHIM_SYSCALL_RETURN_ENOSYS_0(munlockall, int)

SHIM_SYSCALL_RETURN_ENOSYS_0(vhangup, int)

SHIM_SYSCALL_RETURN_ENOSYS_3(modify_ldt, int, int, func, void*, ptr, unsigned long, bytecount)

SHIM_SYSCALL_RETURN_ENOSYS_2(pivot_root, int, const char*, new_root, const char*, put_old)

SHIM_SYSCALL_RETURN_ENOSYS_1(_sysctl, int, struct __kernel_sysctl_args*, args)

SHIM_SYSCALL_RETURN_ENOSYS_5(prctl, int, int, option, unsigned long, arg2, unsigned long, arg3,
...
SHIM_SYSCALL_RETURN_ENOSYS_1(adjtimex, int, struct ____kernel_timex*, txc_p)
...
SHIM_SYSCALL_RETURN_ENOSYS_0(sync, int)

SHIM_SYSCALL_RETURN_ENOSYS_1(acct, int, const char*, name)

SHIM_SYSCALL_RETURN_ENOSYS_2(settimeofday, int, struct timeval*, tv, struct __kernel_timezone*, tz)

SHIM_SYSCALL_RETURN_ENOSYS_5(mount, int, char*, dev_name, char*, dir_name, char*, type,
                             unsigned long, flags, void*, data)

SHIM_SYSCALL_RETURN_ENOSYS_2(umount2, int, const char*, target, int, flags)

SHIM_SYSCALL_RETURN_ENOSYS_2(swapon, int, const char*, specialfile, int, swap_flags)

SHIM_SYSCALL_RETURN_ENOSYS_1(swapoff, int, const char*, specialfile)

SHIM_SYSCALL_RETURN_ENOSYS_4(reboot, int, int, magic1, int, magic2, int, cmd, void*, arg)

SHIM_SYSCALL_RETURN_ENOSYS_2(sethostname, int, char*, name, int, len)

SHIM_SYSCALL_RETURN_ENOSYS_2(setdomainname, int, char*, name, int, len)

#if defined(__i386__) || defined(__x86_64__)
SHIM_SYSCALL_RETURN_ENOSYS_1(iopl, int, int, level)

SHIM_SYSCALL_RETURN_ENOSYS_3(ioperm, int, unsigned long, from, unsigned long, num, int, on)
#endif

SHIM_SYSCALL_RETURN_ENOSYS_2(create_module, int, const char*, name, size_t, size)

SHIM_SYSCALL_RETURN_ENOSYS_3(init_module, int, void*, umod, unsigned long, len, const char*, uargs)

SHIM_SYSCALL_RETURN_ENOSYS_2(delete_module, int, const char*, name_user, unsigned int, flags)

/*
SHIM_SYSCALL_RETURN_ENOSYS(get_kernel_syms, 1, int, struct kernel_sym*, table)
*/

SHIM_SYSCALL_RETURN_ENOSYS_5(query_module, int, const char*, name, int, which, void*, buf, size_t,
                             bufsize, size_t*, retsize)

SHIM_SYSCALL_RETURN_ENOSYS_4(quotactl, int, int, cmd, const char*, special, qid_t, id, void*, addr)

/*
SHIM_SYSCALL_RETURN_ENOSYS_3(nfsservctl, int, int, cmd, struct nfsctl_arg*, arg, void*, res)
*/
...
SHIM_SYSCALL_RETURN_ENOSYS_3(readahead, int, int, fd, loff_t, offset, size_t, count)

SHIM_SYSCALL_RETURN_ENOSYS_5(setxattr, int, const char*, path, const char*, name, const void*,
                             value, size_t, size, int, flags)

SHIM_SYSCALL_RETURN_ENOSYS_5(lsetxattr, int, const char*, path, const char*, name, const void*,
                             value, size_t, size, int, flags)

SHIM_SYSCALL_RETURN_ENOSYS_5(fsetxattr, int, int, fd, const char*, name, const void*, value,
                             size_t, size, int, flags)

SHIM_SYSCALL_RETURN_ENOSYS_4(getxattr, int, const char*, path, const char*, name, void*, value,
                             size_t, size)

SHIM_SYSCALL_RETURN_ENOSYS_4(lgetxattr, int, const char*, path, const char*, name, void*, value,
                             size_t, size)

SHIM_SYSCALL_RETURN_ENOSYS_4(fgetxattr, int, int, fd, const char*, name, void*, value, size_t,
                             size)

SHIM_SYSCALL_RETURN_ENOSYS_3(listxattr, int, const char*, path, char*, list, size_t, size)

SHIM_SYSCALL_RETURN_ENOSYS_3(llistxattr, int, const char*, path, char*, list, size_t, size)

SHIM_SYSCALL_RETURN_ENOSYS_3(flistxattr, int, int, fd, char*, list, size_t, size)

SHIM_SYSCALL_RETURN_ENOSYS_2(removexattr, int, const char*, path, const char*, name)

SHIM_SYSCALL_RETURN_ENOSYS_2(lremovexattr, int, const char*, path, const char*, name)

SHIM_SYSCALL_RETURN_ENOSYS_2(fremovexattr, int, int, fd, const char*, name)
...
#if defined(__i386__) || defined(__x86_64__)
SHIM_SYSCALL_RETURN_ENOSYS_1(set_thread_area, int, struct user_desc*, u_info)
#endif

/* no glibc wrapper */

SHIM_SYSCALL_RETURN_ENOSYS_2(io_setup, int, unsigned, nr_reqs, aio_context_t*, ctx)

SHIM_SYSCALL_RETURN_ENOSYS_1(io_destroy, int, aio_context_t, ctx)

SHIM_SYSCALL_RETURN_ENOSYS_5(io_getevents, int, aio_context_t, ctx_id, long, min_nr, long, nr,
                             struct io_event*, events, struct timespec*, timeout)

SHIM_SYSCALL_RETURN_ENOSYS_3(io_submit, int, aio_context_t, ctx_id, long, nr, struct iocb**,
                             iocbpp)

SHIM_SYSCALL_RETURN_ENOSYS_3(io_cancel, int, aio_context_t, ctx_id, struct iocb*, iocb,
                             struct io_event*, result)

#if defined(__i386__) || defined(__x86_64__)
SHIM_SYSCALL_RETURN_ENOSYS_1(get_thread_area, int, struct user_desc*, u_info)
#endif

SHIM_SYSCALL_RETURN_ENOSYS_3(lookup_dcookie, int, unsigned long, cookie64, char*, buf, size_t, len)
...
SHIM_SYSCALL_RETURN_ENOSYS_5(remap_file_pages, int, void*, start, size_t, size, int, prot, ssize_t,
                             pgoff, int, flags)
...
SHIM_SYSCALL_RETURN_ENOSYS_0(restart_syscall, int)
...
SHIM_SYSCALL_RETURN_ENOSYS_4(fadvise64, int, int, fd, loff_t, offset, size_t, len, int, advice)

SHIM_SYSCALL_RETURN_ENOSYS_3(timer_create, int, clockid_t, which_clock, struct sigevent*,
                             timer_event_spec, timer_t*, created_timer_id)

SHIM_SYSCALL_RETURN_ENOSYS_4(timer_settime, int, timer_t, timer_id, int, flags,
                             const struct __kernel_itimerspec*, new_setting,
                             struct __kernel_itimerspec*, old_setting)

SHIM_SYSCALL_RETURN_ENOSYS_2(timer_gettime, int, timer_t, timer_id, struct __kernel_itimerspec*,
                             setting)

SHIM_SYSCALL_RETURN_ENOSYS_1(timer_getoverrun, int, timer_t, timer_id)

SHIM_SYSCALL_RETURN_ENOSYS_1(timer_delete, int, timer_t, timer_id)

SHIM_SYSCALL_RETURN_ENOSYS_2(clock_settime, int, clockid_t, which_clock, const struct timespec*,
                             tp)
...
SHIM_SYSCALL_RETURN_ENOSYS_2(utimes, int, char*, filename, struct timeval*, utimes)
...
SHIM_SYSCALL_RETURN_ENOSYS_3(set_mempolicy, int, int, mode, unsigned long*, nmask, unsigned long,
                             maxnode)

SHIM_SYSCALL_RETURN_ENOSYS_5(get_mempolicy, int, int*, policy, unsigned long*, nmask, unsigned long,
                             maxnode, unsigned long, addr, unsigned long, flags)

SHIM_SYSCALL_RETURN_ENOSYS_4(mq_open, int, const char*, name, int, oflag, mode_t, mode,
                             struct __kernel_mq_attr*, attr)

SHIM_SYSCALL_RETURN_ENOSYS_1(mq_unlink, int, const char*, name)

SHIM_SYSCALL_RETURN_ENOSYS_5(mq_timedsend, int, __kernel_mqd_t, mqdes, const char*, msg_ptr,
                             size_t, msg_len, unsigned int, msg_prio, const struct timespec*,
                             abs_timeout)

SHIM_SYSCALL_RETURN_ENOSYS_5(mq_timedreceive, int, __kernel_mqd_t, mqdes, char*, msg_ptr, size_t,
                             msg_len, unsigned int*, msg_prio, const struct timespec*, abs_timeout)

SHIM_SYSCALL_RETURN_ENOSYS_2(mq_notify, int, __kernel_mqd_t, mqdes, const struct sigevent*,
                             notification)

SHIM_SYSCALL_RETURN_ENOSYS_3(mq_getsetattr, int, __kernel_mqd_t, mqdes,
                             const struct __kernel_mq_attr*, mqstat, struct __kernel_mq_attr*,
                             omqstat)

/*
SHIM_SYSCALL_RETURN_ENOSYS_4(kexec_load, int, unsigned long, entry, unsigned long, nr_segments,
                           struct kexec_segment*, segments, unsigned long, flags)
*/

SHIM_SYSCALL_RETURN_ENOSYS_5(waitid, int, int, which, pid_t, pid, siginfo_t*, infop, int, options,
                             struct __kernel_rusage*, ru)

/*
SHIM_SYSCALL_RETURN_ENOSYS_5(add_key, int, const char*, type, const char*, description,
                             const void*, payload, size_t, plen, key_serial_t, destringid)
*/

/*
SHIM_SYSCALL_RETURN_ENOSYS_4(request_key, int, const char*, type, const char*, description,
                             const char *, callout_info, key_serial_t, destringid)
*/

/*
SHIM_SYSCALL_RETURN_ENOSYS_5(keyctl, int, int, cmd, unsigned long, arg2, unsigned long, arg3,
                             unsigned long, arg4, unsigned long, arg5)
*/

SHIM_SYSCALL_RETURN_ENOSYS_3(ioprio_set, int, int, which, int, who, int, ioprio)

SHIM_SYSCALL_RETURN_ENOSYS_2(ioprio_get, int, int, which, int, who)

SHIM_SYSCALL_RETURN_ENOSYS_0(inotify_init, int)

SHIM_SYSCALL_RETURN_ENOSYS_3(inotify_add_watch, int, int, fd, const char*, path, unsigned int,
                             mask)

SHIM_SYSCALL_RETURN_ENOSYS_2(inotify_rm_watch, int, int, fd, unsigned int, wd)

SHIM_SYSCALL_RETURN_ENOSYS_4(migrate_pages, int, pid_t, pid, unsigned long, maxnode,
...
SHIM_SYSCALL_RETURN_ENOSYS_3(futimesat, int, int, dfd, const char*, filename, struct timeval*,
                             utimes)
...
SHIM_SYSCALL_RETURN_ENOSYS_5(linkat, int, int, olddfd, const char*, oldname, int, newdfd,
                             const char*, newname, int, flags)

SHIM_SYSCALL_RETURN_ENOSYS_3(symlinkat, int, const char*, oldname, int, newdfd, const char*,
                           newname)

SHIM_SYSCALL_RETURN_ENOSYS_4(readlinkat, int, int, dfd, const char*, path, char*, buf, int, bufsiz)
...
SHIM_SYSCALL_RETURN_ENOSYS_1(unshare, int, int, unshare_flags)
...
SHIM_SYSCALL_RETURN_ENOSYS_6(splice, int, int, fd_in, loff_t*, off_in, int, fd_out, loff_t*,
                             off_out, size_t, len, int, flags)

SHIM_SYSCALL_RETURN_ENOSYS_4(tee, int, int, fdin, int, fdout, size_t, len, unsigned int, flags)

SHIM_SYSCALL_RETURN_ENOSYS_4(sync_file_range, int, int, fd, loff_t, offset, loff_t, nbytes, int,
                             flags)

SHIM_SYSCALL_RETURN_ENOSYS_4(vmsplice, int, int, fd, const struct iovec*, iov, unsigned long,
                             nr_segs, int, flags)

SHIM_SYSCALL_RETURN_ENOSYS_6(move_pages, int, pid_t, pid, unsigned long, nr_pages, void**, pages,
                             const int*, nodes, int*, status, int, flags)

SHIM_SYSCALL_RETURN_ENOSYS_4(utimensat, int, int, dfd, const char*, filename, struct timespec*,
                             utimes, int, flags)
...
SHIM_SYSCALL_RETURN_ENOSYS_3(signalfd, int, int, ufd, __sigset_t*, user_mask, size_t, sizemask)

SHIM_SYSCALL_RETURN_ENOSYS_2(timerfd_create, int, int, clockid, int, flags)

SHIM_SYSCALL_RETURN_ENOSYS_4(fallocate, int, int, fd, int, mode, loff_t, offset, loff_t, len)

SHIM_SYSCALL_RETURN_ENOSYS_4(timerfd_settime, int, int, ufd, int, flags,
                           const struct __kernel_itimerspec*, utmr, struct __kernel_itimerspec*,
                           otmr)

SHIM_SYSCALL_RETURN_ENOSYS_2(timerfd_gettime, int, int, ufd, struct __kernel_itimerspec*, otmr)

/* accept4: sys/shim_socket.c */
DEFINE_SHIM_SYSCALL(accept4, 4, shim_do_accept4, int, int, sockfd, struct sockaddr*, addr,
                    int*, addrlen, int, flags)

SHIM_SYSCALL_RETURN_ENOSYS_4(signalfd4, int, int, ufd, __sigset_t*, user_mask, size_t, sizemask,
                             int, flags)
...
SHIM_SYSCALL_RETURN_ENOSYS_1(inotify_init1, int, int, flags)

SHIM_SYSCALL_RETURN_ENOSYS_5(preadv, int, unsigned long, fd, const struct iovec*, vec,
                             unsigned long, vlen, unsigned long, pos_l, unsigned long, pos_h)

SHIM_SYSCALL_RETURN_ENOSYS_5(pwritev, int, unsigned long, fd, const struct iovec*, vec,
                             unsigned long, vlen, unsigned long, pos_l, unsigned long, pos_h)

SHIM_SYSCALL_RETURN_ENOSYS_4(rt_tgsigqueueinfo, int, pid_t, tgid, pid_t, pid, int, sig, siginfo_t*,
                             uinfo)

SHIM_SYSCALL_RETURN_ENOSYS_5(perf_event_open, int, struct perf_event_attr*, attr_uptr, pid_t, pid,
...
SHIM_SYSCALL_RETURN_ENOSYS_2(fanotify_init, int, int, flags, int, event_f_flags)

SHIM_SYSCALL_RETURN_ENOSYS_5(fanotify_mark, int, int, fanotify_fd, int, flags, unsigned long, mask,
...
SHIM_SYSCALL_RETURN_ENOSYS_5(name_to_handle_at, int, int, dfd, const char*, name,
                             struct linux_file_handle*, handle, int*, mnt_id, int, flag)

SHIM_SYSCALL_RETURN_ENOSYS_3(open_by_handle_at, int, int, mountdirfd, struct linux_file_handle*,
                             handle, int, flags)

SHIM_SYSCALL_RETURN_ENOSYS_2(clock_adjtime, int, clockid_t, which_clock, struct timex*, tx)

SHIM_SYSCALL_RETURN_ENOSYS_1(syncfs, int, int, fd)

DEFINE_SHIM_SYSCALL(sendmmsg, 4, shim_do_sendmmsg, ssize_t, int, fd, struct mmsghdr*, msg,
                    unsigned int, vlen, int, flags)

SHIM_SYSCALL_RETURN_ENOSYS_2(setns, int, int, fd, int, nstype)

SHIM_SYSCALL_RETURN_ENOSYS_3(getcpu, int, unsigned*, cpu, unsigned*, node, struct getcpu_cache*,
                             cache)
