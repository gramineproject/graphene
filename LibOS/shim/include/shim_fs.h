...
struct shim_fs_ops {
    ...
    loff_t (*seek)(struct shim_handle* hdl, loff_t offset, int whence);
    ...
    int (*truncate)(struct shim_handle* hdl, loff_t len);
...
loff_t str_seek(struct shim_handle* hdl, loff_t offset, int whence);
int str_flush(struct shim_handle* hdl);
int str_truncate(struct shim_handle* hdl, loff_t len);
 ...
 */
int generic_seek(loff_t pos, loff_t size, loff_t offset, int origin, loff_t* out_pos);
