...
/*
 * Decrement the reference count on `dent`, and delete it from the tree if possible (i.e. there are
 * no references to it except parent, and it does not represent a real file (it's either invalid or
 * negative).
 */
