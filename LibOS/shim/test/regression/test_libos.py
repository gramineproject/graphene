...
class TC_03_FileCheckPolicy(RegressionTestCase):
    ...
    def test_002_allow_all_but_log_success(self):
        stdout, stderr = self.run_binary(['file_check_policy_allow_all_but_log', 'unknown_testfile'])
    ...
    def test_003_allow_all_but_log_fail(self):
        stdout, stderr = self.run_binary(['file_check_policy_allow_all_but_log', 'trusted_testfile'])
