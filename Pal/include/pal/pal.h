...
PAL_NUM DkThreadSetCpuAffinity(PAL_HANDLE thread, PAL_NUM cpumask_len, PAL_PTR cpu_mask);

PAL_NUM DkThreadGetCpuAffinity(PAL_HANDLE thread, PAL_NUM cpumask_len, PAL_PTR cpu_mask);
