...
/* Stream Create Flags */
#define PAL_CREATE_TRY                   \
    0100 /* 0100 Create file if file not \
           exist (O_CREAT) */
#define PAL_CREATE_ALWAYS                     \
    0200 /* 0300 Create file and fail if file \
...
PAL_PTR
DkStreamMap(PAL_HANDLE handle, PAL_PTR address, PAL_FLG prot, PAL_NUM offset, PAL_NUM size);
...
PAL_NUM
DkPhysicalMemoryMap(PAL_HANDLE channel, PAL_NUM entries, PAL_PTR* addrs, PAL_NUM* sizes,
                    PAL_FLG* prots);
