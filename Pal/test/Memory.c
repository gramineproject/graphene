...
{
    void * p1 = DkVirtualMemoryAlloc (NULL, pal_control.alloc_align * 4, 0,
                               PAL_PROT_READ|PAL_PROT_WRITE);

    void * p2 = DkVirtualMemoryAlloc (NULL, pal_control.alloc_align * 4, 0,
                               PAL_PROT_READ|PAL_PROT_WRITE);

    void * p3 = DkVirtualMemoryAlloc (NULL, pal_control.alloc_align * 2, 0,
                               PAL_PROT_READ|PAL_PROT_WRITE);
