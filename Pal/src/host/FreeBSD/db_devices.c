...
static int char_write(PAL_HANDLE handle, int offset, int count, const void* buffer);
...
static int char_write(PAL_HANDLE handle, int offset, int size, const void* buffer) {
...
static int dev_write(PAL_HANDLE handle, int offset, int size, const void* buffer) {
    const struct handle_ops* ops = DEVICE_OPS(handle);
