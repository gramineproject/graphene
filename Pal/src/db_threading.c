...
PAL_BOL DkThreadSetCPUAffinity(PAL_NUM pid, PAL_NUM cpu_num, PAL_PTR cpu_indexes) {
    ENTER_PAL_CALL(DkThreadSetCPUAffinity);

    int ret = _DkThreadSetCPUAffinity(pid, cpu_num, cpu_indexes);
...
PAL_BOL DkThreadGetCPUAffinity(PAL_NUM pid, PAL_NUM cpu_num, PAL_PTR cpu_indexes) {
    ENTER_PAL_CALL(DkThreadGetCPUAffinity);

    int ret = _DkThreadGetCPUAffinity(pid, cpu_num, cpu_indexes);
