...
#define CHECK_PTR(msg) \
    ...
    while (RANGE) {
        ...
        for (; RANGE; ptr++) {
            ...
            /* Jump out when meeting an invalid character outside allowed charactors */
        ...
        /* Skip the whitespaces between key portion and equal mark */
        ...
        /* Skip the whitespaces between equal mark and value portion */
        for (; RANGE && IS_SPACE(*ptr); ptr++)
            ;
