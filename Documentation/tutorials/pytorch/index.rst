...
- PyTorch (Python3). PyTorch is a framework for machine learning based on
  Python. Please `install PyTorch <https://pytorch.org/get-started/locally/>`_
...
- Intel SGX Driver and SDK/PSW. You need a machine that supports Intel SGX and
  ...
  <https://download.01.org/intel-sgx/latest/linux-latest/docs/Intel_SGX_Installation_Guide_Linux_2.10_Open_Source.pdf>`_
...
- Graphene. Follow `Quick Start
  <https://graphene.readthedocs.io/en/latest/quickstart.html>`_ to build
...
example <https://github.com/oscarlab/graphene/tree/master/Examples/pytorch>`_
...
<https://pytorch.org/docs/stable/torchvision/models.html>`_ and an image
...
<https://pytorch.org/tutorials/beginner/saving_loading_models.html>`_ for more
details.
...
<https://graphene.readthedocs.io/en/latest/manifest-syntax.html>`_ for further
...
<https://graphene.readthedocs.io/en/latest/manifest-syntax.html?highlight=manifest#sgx-syntax>`_.
...
<https://graphene.readthedocs.io/en/latest/manifest-syntax.html?highlight=protected#protected-files>`_,
...
<https://github.com/oscarlab/graphene/tree/master/Examples/ra-tls-secret-prov>`_
...
<https://github.com/oscarlab/graphene/tree/master/Pal/src/host/Linux-SGX/tools#secret-provisioning-libraries>`_::
