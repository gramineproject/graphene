...
This API receives a handle upon other handles.
...
This API will suspend the current thread for a certain duration (in microseconds).
...
This API creates a mutex with the given _initialCount_.
...
This API commits (sends) an array of the virtual memory area to the physical memory channel.
