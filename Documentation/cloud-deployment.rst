...
Graphene requires FSGSBASE support to be enabled in the kernel. If it is not
enabled in the Azure-provided VM, please refer to `Building Graphene
<https://graphene.readthedocs.io/en/latest/building.html#install-the-linux-kernel-patched-with-fsgsbase>`__
section for details.
