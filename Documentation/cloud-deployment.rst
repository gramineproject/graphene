...
#. Configure GSC to build graphenized images for AKS with the `Graphene Docker Image for AKS from Docker Hub <https://hub.docker.com/repository/docker/graphenelibos/aks>`__ by creating the following configuration file :file:`config.aks.yaml`::
...
#. You may need to follow this `guide <https://kubernetes.io/docs/tasks/configure-pod-container/pull-image-private-registry/>`__ to pull from a private registry.
